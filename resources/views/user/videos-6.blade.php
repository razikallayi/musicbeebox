			...
			<div class="card">
				...
				<div class="body">
					<div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
						<!-- Wrapper for slides -->
						<div class="carousel-inner" role="listbox">
							<iframe width="460" height="260" src="https://www.youtube.com/embed/2vJcj343Xak" frameborder="0" allowfullscreen></iframe>
						</div>
			...
			<div class="card">
				...
				<div class="body">
					<div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
						<!-- Wrapper for slides -->
						<div class="carousel-inner" role="listbox">
							<iframe width="460" height="260" src="https://www.youtube.com/embed/Sietpr9Wol8" frameborder="0" allowfullscreen></iframe>
						</div>
			...
			<div class="card">
				...
				<div class="body">
					<div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
						<!-- Wrapper for slides -->
						<div class="carousel-inner" role="listbox">
							<iframe width="460" height="260" src="https://www.youtube.com/embed/gNZKmmmSvZw" frameborder="0" allowfullscreen></iframe>
						</div>
