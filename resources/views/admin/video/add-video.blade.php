...
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
	...
	<div class="card">
		<div class="body">
			...
			<form id="form_validation" method="POST" action="{{url('admin/upload-video')}}" enctype="multipart/form-data">
				{{csrf_field()}}
			...
			{{-- ##################### session flash message ends here ##################--}}
				...
				<div class="row clearfix">
					<div class="col-sm-12">
						<div class="form-group ">
							<div class="form-line">
								<input type="file" name="videos" accept="video/*" class="form-control" required>
							</div>
						</div>
					</div>
				</div>
